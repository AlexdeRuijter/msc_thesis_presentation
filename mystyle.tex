...
%% math packages: -----------------------------------------
\usepackage{amsmath,amssymb,mathrsfs,amsfonts,mathtools} 
...
% Add an inline version of the todonote
\newtcolorbox{todonote}[1][breakable, enhanced]
{
  colframe = white!25!black,
  colback  = orange!80!white,  
  title    = {\texttt{\textbf{TO-DO}}},
  #1, 
}
\newcommand{\todo}[1]{% A inline command for the same idea
\begin{todonote}
#1
\end{todonote}
}
